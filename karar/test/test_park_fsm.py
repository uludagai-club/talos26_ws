...
check("karar=park_musait_degil", bb.last_decision.get("karar") == "park_musait_degil")
...
check("karar=park_musait", bb.last_decision.get("karar") == "park_musait")
...
check("karar=park_musait_degil (yasak)", bb.last_decision.get("karar") == "park_musait_degil")
